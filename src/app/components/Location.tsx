      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Visit us at our office or get in touch for site visits and
            consultations
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Located in Medie, just off the Accra-Nsawam Road, we&apos;re
                conveniently positioned to serve projects across Greater Accra
                and beyond.{" "}
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-2">
                    For urgent scaffolding needs outside business hours, our
                    emergency team is available 24/7.
                  </p>
                  <div className="space-y-1">
                    <a
                      href="tel:+233544993344"
                      className="text-orange-500 font-semibold hover:text-orange-600 transition-colors duration-300 block"
                    >
                      +233 54 499 3344
                    </a>
                    <a
